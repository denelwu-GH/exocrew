...
![ExoCrew 的六个交付角色](https://raw.githubusercontent.com/denelwu-GH/exocrew/main/docs/launch/wechat/images/02-team.png)
...
先区分搬运、重构、升级、替换还是开源提炼，再用成熟度和等价证据阻止项目反复重写。
